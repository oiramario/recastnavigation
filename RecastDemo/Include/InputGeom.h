...
public:
    ...
    bool loadMesh(class rcContext* ctx, const char* filepath, bool trinityCoreSettings);
	
	bool load(class rcContext* ctx, const char* filepath, bool trinityCoreSettings);
